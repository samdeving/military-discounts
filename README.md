=== Military Discounts ===
Contributors: samdeving
Tags: military, veterans, discounts, woocommerce, verification
...
WooCommerce plugin that verifies US military and veterans status using VA Lighthouse API and Military Email OTP to issue discount coupons.
